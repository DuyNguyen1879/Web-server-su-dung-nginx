# Cài d?t nginx t? d?ng b?ng scritp trên ubuntu 14.04
1. Download script t?i [dây] () ho?c t?o m?t file *nginx.sh* v?i n?i dung nhu sau
...
2. C?p quy?n th?c thi (excute) cho file script (d?m b?o v?i các user thu?c nhóm o (other) cung có th? th?c hi?n du?c file
...
4. Truy c?p vào d?a ch? server v?i thông báo hi?n th?